...
import ghww.bottlenosesender.R;
...
//        Button scanButton = null;// (Button) findViewById(R.id.button_scan);
...
//        });
        ...
        if (pairedDevices.size() > 0) {
            //findViewById(R.string.buttName).setVisibility(View.VISIBLE);
            for (BluetoothDevice device : pairedDevices) {
                mPairedDevicesArrayAdapter.add(device.getName() + "\n" + device.getAddress());
            }
        } else {
            String noDevices = "".toString();
